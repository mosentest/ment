 ...
 */
@MessageDriven(mappedName = "queue/communication/chat", name="communicationChatQueue", activationConfig = {
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/communication/chat"),
